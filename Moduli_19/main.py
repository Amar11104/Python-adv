...
from Moduli_13.kaggle_data.kaggle_dataset import filtered_df
...
with col2:
    ...
    top_authors = filtered_books_df['Name'].value_counts().head(10)
    st.bar_chart(top_authors)

st.subheader=("Genre Distribution")
fig = px.pie(filtered_books_df, names='Genre', title='Most Liked Genre (2019-2022)', color='Genre',
